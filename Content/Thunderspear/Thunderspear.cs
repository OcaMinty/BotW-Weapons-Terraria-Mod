...
namespace OneHitObliterator.Content.Thunderspear
{
    public class Thunderspear : ModItem
    {
        ...
        {
            Tooltip.SetDefault("Not-so Pool Stick\n(Right Click to Throw)");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<ThunderspearProjectile>();
        ...
        public override bool CanUseItem(Player player)
        {
            if (player.altFunctionUse == 2)//Sets what happens on right click(special ability)
            {
                ...
                Item.knockBack = 5;
                Item.crit = 10;
                Item.shoot = ModContent.ProjectileType<ThunderspearThrow>();
                Item.shootSpeed = 10f;
            }
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemID.LightningBug, 65)
